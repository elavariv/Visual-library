...
### Learnings
#### Line chart
1. Line generator requires the input to have an array of data point with values for x & y. All data points are connected to form the line. So, the input data should be an **array of array**
